...
public class CameraFeed
{
	...
	public CameraFeed(Controller newContr)
	{
        // Get camera ids by supplying camera name ex 'cam0', found on roborio web interface
        camCenter = NIVision.IMAQdxOpenCamera(Config.CameraFeed.camNameCenter, NIVision.IMAQdxCameraControlMode.CameraControlModeController);
        ...
        server.setQuality(Config.CameraFeed.imgQuality);
        contr = newContr;
	}
